...
The complete `docs/` tree was re-opened and cross-checked against the current repository implementation and accepted decisions. Stale older-phase wording was repaired in market-data, structure, indicators, liquidity, news, Entry Timing, Trade Plan, Risk, Session/Risk and Research authorities; compatibility files remain redirects only.

At this checkpoint there is **no known cross-document behavioural contradiction or missing authoritative home** blocking implementation. Remaining PENDING items are genuine integration/calibration/evidence work recorded in `90-governance/OPEN_QUESTIONS.md`, not undocumented design gaps.

This audit is a documentation-consistency checkpoint, not release verification. `FINAL_RELEASE_AUDIT.md` remains evidence-driven and PENDING until the exact release candidate is tested.
...
| Document | Status | Purpose |
|---|---|---|
| [Market Data and History](10-market-intelligence/MARKET_DATA_AND_HISTORY.md) | PROVISIONAL — implemented baseline | Rolling history, timeframe data and data-quality rules |
| [Candle Structure and Price Behaviour](10-market-intelligence/CANDLE_STRUCTURE.md) | PROVISIONAL — implemented baseline | Candle sequences, swing lifecycle, BOS/MSS, displacement, rejection, compression/expansion |
| [Technical Structure and Levels](10-market-intelligence/TECHNICAL_STRUCTURE_AND_LEVELS.md) | PROVISIONAL — implemented baseline | S/R zones, location/target room plus causal Trendline/Fibonacci/broker-local POC confluence ownership |
| [Liquidity and SMC](10-market-intelligence/LIQUIDITY_AND_SMC.md) | PROVISIONAL — implemented baseline | Liquidity pools/sweeps, FVG, qualified OB, premium/discount/path |
| [Indicators and Volatility](10-market-intelligence/INDICATORS_AND_VOLATILITY.md) | PROVISIONAL — implemented baseline | EMA/RSI/ATR, volatility, momentum, extension |
| [Fundamental and News](10-market-intelligence/FUNDAMENTAL_AND_NEWS.md) | PROVISIONAL — fact normalization implemented | Macro opinion/event facts/provider health; hard permission lives in risk/session safety |
| [Session Context](10-market-intelligence/SESSION_CONTEXT.md) | PROVISIONAL — implemented baseline | Asia/London/New York market evidence; not hard permission state |
...
| Document | Status | Purpose |
|---|---|---|
| [Strategy Floor](20-trading-decisions/STRATEGY_FLOOR.md) | PROVISIONAL — implemented baseline | Six parallel production families + optional bounded confluence support |
| [Entry Timing](20-trading-decisions/ENTRY_TIMING.md) | PROVISIONAL — implemented baseline | Persistent setup lifecycle/executable timing |
| [Scoring and Decision Fusion](20-trading-decisions/SCORING_AND_DECISION_FUSION.md) | PROVISIONAL — implemented baseline | BUY/SELL theses, conflict/scoring/Red Team/why-no-trade |
| [Trade Plan](20-trading-decisions/TRADE_PLAN.md) | PROVISIONAL — implemented baseline | Entry reference, structural invalidation/SL, targets/RR/original R |
| [Trade Manager and Exit](20-trading-decisions/TRADE_MANAGER_AND_EXIT.md) | PROVISIONAL — implemented baseline | HOLD/PROTECT/TRAIL/RUNNER/EXIT |

## 30 — Risk and Execution

| Document | Status | Purpose |
|---|---|---|
| [Risk Contract](30-risk-execution/RISK_CONTRACT.md) | PROVISIONAL — implemented baseline | Monetary risk, hybrid sizing, UTC risk day, loss lock/reset/exposure |
| [Session and Risk State Machine](30-risk-execution/SESSION_AND_RISK_STATE_MACHINE.md) | PROVISIONAL — implemented baseline | Hard market/news/risk/system permission states |
| [Execution and Broker Safety](30-risk-execution/EXECUTION_AND_BROKER_SAFETY.md) | PROVISIONAL — implemented baseline | DEMO guard, gate, MT5 safety, one-shot writes, controller/reconciliation |
| [Persistence, Restart and Recovery](30-risk-execution/PERSISTENCE_RESTART_AND_RECOVERY.md) | PROVISIONAL — implemented foundation | SQLite durable lifecycle, backup/restore/laptop migration contract |

## 40 — Research and Learning

| Document | Status | Purpose |
|---|---|---|
| [Research and Validation](40-research-learning/RESEARCH_AND_VALIDATION.md) | PROVISIONAL — implemented foundation | Chronological replay, validation, ablation, Opportunity Recall, holdouts/stress |
| [Governed Strategy Discovery](40-research-learning/GOVERNED_STRATEGY_DISCOVERY.md) | PROVISIONAL — implemented foundation | Working discovery liveness, audited primitives, candidate comparison |
| [Autonomous Strategy Invention](40-research-learning/AUTONOMOUS_STRATEGY_INVENTION.md) | PROVISIONAL — implemented foundation | Bounded declarative invention/genealogy/prohibited self-writing |
| [Governed Experiments and Promotion](40-research-learning/GOVERNED_EXPERIMENTS_AND_PROMOTION.md) | PROVISIONAL — implemented foundation | Challenger/holdout/Shadow/DEMO Canary/promotion/rollback |
| [Learning and AI Boundaries](40-research-learning/LEARNING_AND_AI_BOUNDARIES.md) | PROVISIONAL — implemented foundation | StrategyMemory, entry/exit learning, AI authority limits |
